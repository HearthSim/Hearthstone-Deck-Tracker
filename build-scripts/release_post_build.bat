...
xcopy /Y "..\..\..\..\HDTUpdate\bin\x86\Release\net472\HDTUpdate.exe" "..\Hearthstone Deck Tracker"
xcopy /Y "..\..\..\..\HDTUninstaller\bin\x86\Release\net472\HDTUninstaller.exe" "..\Hearthstone Deck Tracker"
