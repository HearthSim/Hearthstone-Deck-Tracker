...
namespace HDTTests.HearthStats
{
	...
	public class ApiTest
	{
		...
		private static void GenerateTestDecks()
		{
			...
			_deck1.Class = "Mage";
			foreach(var card in Database.GetActualCards().Where(c => c.PlayerClass.Equals("Mage")).Take(30))
			...
			_deck2.Class = "Druid";
			foreach(var card in Database.GetActualCards().Where(c => c.PlayerClass.Equals("Druid")).Take(30))
