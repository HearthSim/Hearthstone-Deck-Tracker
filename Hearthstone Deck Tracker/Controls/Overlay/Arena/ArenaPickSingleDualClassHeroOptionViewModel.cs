...
public class ArenaPickSingleDualClassHeroOptionViewModel : ArenaPickSingleHeroOptionViewModel
{
	...
	public ArenaPickSingleDualClassHeroOptionViewModel(ArenaHeroPickApiResponse.ResponseData? data, bool isUnderground, int position) : base(data, isUnderground)
	{
		Data = data;
		...
		Margin = new Thickness(position != 2 ? 0 : HorizontalMargin, 428, position != 0 ? 0 : HorizontalMargin, 0);

		var plaqueMargin =  new Thickness(position != 2 ? 0 : HorizontalMargin, 170, position != 0 ? 0 : HorizontalMargin, 0);
	...
	// Loading State
	public ArenaPickSingleDualClassHeroOptionViewModel(bool isUnderground, int position) : base(isUnderground)
	{
		IsUnderground = isUnderground;
