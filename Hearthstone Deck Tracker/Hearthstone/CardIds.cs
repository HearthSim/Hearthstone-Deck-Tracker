	...
	public class CardIds
	{
		...
		public static class Secrets
		{
			...
			public class Hunter : EnumerateMultiId<Hunter>
			{
				...
				public static readonly MultiIdCard PressurePlate = new MultiIdCard(Collectible.Hunter.PressurePlate, Collectible.Hunter.PressurePlateCore);
			...
			public class Mage : EnumerateMultiId<Mage>
			{
				...
				public static readonly MultiIdCard MysticMisdirection = new MultiIdCard(Collectible.Mage.MysticMisdirection);
			}
