...
public class BloodGemBarrageBuffCounter : StatsCounter
{
	...
	public override void HandleTagChange(GameTag tag, IHsGameState gameState, Entity entity, int value, int prevValue)
	{
		...
		if(entity.Card.Id != HearthDb.CardIds.NonCollectible.Neutral.BloodGemBarrage_BloodGemBarragePlayerEnchDntEnchantment)
			return;
