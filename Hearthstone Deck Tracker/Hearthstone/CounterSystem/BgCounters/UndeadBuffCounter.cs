...
public class UndeadBuffCounter : StatsCounter
{
	...
	public override bool ShouldShow() => Game.IsBattlegroundsMatch
	                                     && (AttackCounter > 0 || HealthCounter > 0)
	...
	public override string[] GetCardsToDisplay()
	{
		return new []
		{
			...
			HearthDb.CardIds.NonCollectible.Neutral.DustboneDevastator,
			HearthDb.CardIds.NonCollectible.Neutral.Plaguerunner,
	...
	public override string ValueToShow() => HealthCounter > 0 ? $"+{AttackCounter} / +{HealthCounter}" : $"+{AttackCounter}";
