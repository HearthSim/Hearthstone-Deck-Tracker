...
public class CapturedArchmageCounter : NumericCounter
{
	protected override string? CardIdToShowInUI => HearthDb.CardIds.Collectible.Neutral.CapturedArchmage;

	public override string[] RelatedCards => new string[]
	{
		HearthDb.CardIds.Collectible.Neutral.CapturedArchmage,
	};

	public CapturedArchmageCounter(bool controlledByPlayer, GameV2 game) : base(controlledByPlayer, game)
	{
	}
