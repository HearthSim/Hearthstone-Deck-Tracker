...
public class ElwynnBoarCounter : NumericCounter
{
	protected override string? CardIdToShowInUI => HearthDb.CardIds.Collectible.Neutral.ElwynnBoar;

	public override string[] RelatedCards => new string[]
	{
		HearthDb.CardIds.Collectible.Neutral.ElwynnBoar,
	};

	public ElwynnBoarCounter(bool controlledByPlayer, GameV2 game) : base(controlledByPlayer, game)
	{
	}
