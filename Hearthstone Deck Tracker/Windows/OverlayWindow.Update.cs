...
namespace Hearthstone_Deck_Tracker.Windows
{
	public partial class OverlayWindow
	{
		...
		private void UpdateIcons()
		{
			...
			var showPlayerAlannaCounter = WotogCounterHelper.ShowPlayerAlannaCounter;
			...
			if(showPlayerAlannaCounter)
				WotogIconsPlayer.Alanna = _game.Player.BigSpellsPlayedCount.ToString();
			...
			WotogIconsPlayer.AlannaCounterStyle = showPlayerAlannaCounter ? Full : None;
