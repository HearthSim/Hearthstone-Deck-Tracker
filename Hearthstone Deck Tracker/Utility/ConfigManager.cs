...
namespace Hearthstone_Deck_Tracker.Utility
{
    ...
    {
        private static readonly string LogConfigPath =
        ...
        public static void Run()
        {
            var configVersion = string.IsNullOrEmpty(Config.Instance.CreatedByVersion)
                ? null : new Version(Config.Instance.CreatedByVersion);
...
#pragma warning restore 612
        ...
        private static bool UpdateLogConfigFile()
        {
            ...
            try
            {
                ...
                if (
                    logConfig.Configitems.Any(
                        x => !x.FilePrinting || x.ConsolePrinting != Config.Instance.LogConfigConsolePrinting))
                {
